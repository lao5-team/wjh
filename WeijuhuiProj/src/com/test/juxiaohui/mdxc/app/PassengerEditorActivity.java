...
public class PassengerEditorActivity extends Activity implements
	...
	public void addEditorView() {
		...
		{
			mEdtFirstName.setText(mPassenger.mFirstName);
			mEdtLastName.setText(mPassenger.mLastName);
			mEdtIDNumber.setText(mPassenger.mIdNumber);
		}
		switch (mPassenger.mIdType) 
		{
	...
	public void addConfirmView() {
		...
		mBtnConfirm.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				mPassenger.mFirstName = mEdtFirstName.getText().toString();
				mPassenger.mLastName = mEdtLastName.getText().toString();
				mPassenger.mIdNumber = mEdtIDNumber.getText().toString();		
