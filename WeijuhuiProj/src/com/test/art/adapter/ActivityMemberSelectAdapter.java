...
import com.test.art.activity.ActivityMembersActivity;
import com.test.art.activity.ContactlistFragment;
import com.test.art.domain.User;
...
public class ActivityMemberSelectAdapter extends ArrayAdapter<User>  implements SectionIndexer{
	...
	private int res;
	private ArrayList<com.test.art.data.MyUser> mSelectedMembers = new ArrayList<com.test.art.data.MyUser>();
	 ...
	 */
	public ActivityMemberSelectAdapter(Context context, int resource, List<User> objects, ArrayList<com.test.art.data.MyUser> selectMembers, Sidebar sidebar) {
		...
		if(null!=selectMembers)
		{
			...
			for(com.test.art.data.MyUser user: mSelectedMembers)
			{
...
//		}
	...
	private void addSelectedMember(User user)
	{
		...
		com.test.art.data.MyUser user1 = new com.test.art.data.MyUser();
