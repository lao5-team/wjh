...
import com.pineapple.mobilecraft.app.social.ActivityMembersActivity;
import com.pineapple.mobilecraft.app.social.ContactlistFragment;
import com.pineapple.mobilecraft.data.social.User;
...
public class ActivityMemberSelectAdapter extends ArrayAdapter<User>  implements SectionIndexer{
	...
	private int res;
	private ArrayList<com.pineapple.mobilecraft.data.social.MyUser> mSelectedMembers = new ArrayList<com.pineapple.mobilecraft.data.social.MyUser>();
	 ...
	 */
	public ActivityMemberSelectAdapter(Context context, int resource, List<User> objects, ArrayList<com.pineapple.mobilecraft.data.social.MyUser> selectMembers, Sidebar sidebar) {
		...
		if(null!=selectMembers)
		{
			...
			for(com.pineapple.mobilecraft.data.social.MyUser user: mSelectedMembers)
			{
...
//		}
	...
	private void addSelectedMember(User user)
	{
		...
		com.pineapple.mobilecraft.data.social.MyUser user1 = new com.pineapple.mobilecraft.data.social.MyUser();
