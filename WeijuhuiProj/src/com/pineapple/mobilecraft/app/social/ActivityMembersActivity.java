package com.pineapple.mobilecraft.app.social;
...
public class ActivityMembersActivity extends FragmentActivity {
	...
	private List<com.pineapple.mobilecraft.data.social.User> mContactList = new ArrayList<com.pineapple.mobilecraft.data.social.User>();;
...
//	}	
	private void getContactList() {
		mContactList.clear();
		Map<String, com.pineapple.mobilecraft.data.social.User> users = DemoApplication.getInstance().getContactList();
		Iterator<Entry<String, com.pineapple.mobilecraft.data.social.User>> iterator = users.entrySet().iterator();
		while (iterator.hasNext()) {
			Entry<String, com.pineapple.mobilecraft.data.social.User> entry = iterator.next();
			if (!entry.getKey().equals(Constant.NEW_FRIENDS_USERNAME) && !entry.getKey().equals(Constant.GROUP_USERNAME))
				mContactList.add(entry.getValue());
		}
		// 排序
		Collections.sort(mContactList, new Comparator<com.pineapple.mobilecraft.data.social.User>() {

			@Override
			public int compare(com.pineapple.mobilecraft.data.social.User lhs, com.pineapple.mobilecraft.data.social.User rhs) {
