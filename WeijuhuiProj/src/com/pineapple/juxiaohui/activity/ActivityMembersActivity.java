...
import com.pineapple.juxiaohui.Constant;
import com.pineapple.juxiaohui.DemoApplication;
import com.pineapple.juxiaohui.adapter.ActivityMemberSelectAdapter;
import com.pineapple.juxiaohui.adapter.ActivityMemberStateAdapter;
...
import com.pineapple.juxiaohui.widget.Sidebar;
...
public class ActivityMembersActivity extends FragmentActivity {
	...
	private List<com.pineapple.juxiaohui.domain.User> mContactList = new ArrayList<com.pineapple.juxiaohui.domain.User>();;
...
//	public void addFriend(com.pineapple.juxiaohui.domain.User user)
//	{
...
//	}
//	
//	public void removeFriend(com.pineapple.juxiaohui.domain.User user)
//	{
//		for(int i=0; i<mFriends.size(); i++)
//		{
//			if(mFriends.get(i).mName.equals(user.getNick()))
...
//	}	
	private void getContactList() {
		mContactList.clear();
		Map<String, com.pineapple.juxiaohui.domain.User> users = DemoApplication.getInstance().getContactList();
		Iterator<Entry<String, com.pineapple.juxiaohui.domain.User>> iterator = users.entrySet().iterator();
		while (iterator.hasNext()) {
			Entry<String, com.pineapple.juxiaohui.domain.User> entry = iterator.next();
			if (!entry.getKey().equals(Constant.NEW_FRIENDS_USERNAME) && !entry.getKey().equals(Constant.GROUP_USERNAME))
				mContactList.add(entry.getValue());
		}
		// 排序
		Collections.sort(mContactList, new Comparator<com.pineapple.juxiaohui.domain.User>() {

			@Override
			public int compare(com.pineapple.juxiaohui.domain.User lhs, com.pineapple.juxiaohui.domain.User rhs) {
