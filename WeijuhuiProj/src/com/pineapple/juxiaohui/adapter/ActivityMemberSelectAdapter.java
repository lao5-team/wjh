 ...
 */
package com.pineapple.juxiaohui.adapter;
...
import com.pineapple.juxiaohui.activity.ActivityMembersActivity;
import com.pineapple.juxiaohui.activity.ContactlistFragment;
import com.pineapple.juxiaohui.domain.User;
...
public class ActivityMemberSelectAdapter extends ArrayAdapter<User>  implements SectionIndexer{
	...
	private int res;
	private ArrayList<com.pineapple.juxiaohui.data.MyUser> mSelectedMembers = new ArrayList<com.pineapple.juxiaohui.data.MyUser>();
	 ...
	 */
	public ActivityMemberSelectAdapter(Context context, int resource, List<User> objects, ArrayList<com.pineapple.juxiaohui.data.MyUser> selectMembers, Sidebar sidebar) {
		...
		if(null!=selectMembers)
		{
			...
			for(com.pineapple.juxiaohui.data.MyUser user: mSelectedMembers)
			{
...
//		}
	...
	private void addSelectedMember(User user)
	{
		...
		com.pineapple.juxiaohui.data.MyUser user1 = new com.pineapple.juxiaohui.data.MyUser();
